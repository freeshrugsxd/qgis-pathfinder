...
class Settings:
    ...
    def __new__(cls):
        if cls.instance is None:
            ...
            cls.incl_file_name = QgsSettingsEntryBool(name='incl_file_name', parent=settings_node, defaultValue=False, description='Whether to include the file name.')
            cls.incl_layer_name = QgsSettingsEntryBool(name='incl_layer_name', parent=settings_node, defaultValue=True, description='Whether to append the layer name part to the path. Useful for file formats that can containing multiple layers.')
